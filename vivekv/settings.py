"""
Django settings for vivekv project.
...
SECRET_KEY = '%*+zl0arn42re)--&e3lp&_y!k-xjr*y8sw@7qr3gxvoufr$u3'
...
WSGI_APPLICATION = 'vivekv.wsgi.application'
